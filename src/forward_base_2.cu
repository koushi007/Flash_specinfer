...
std::vector<torch::Tensor> forward_base_2(torch::Tensor Q, torch::Tensor K, torch::Tensor V,
    ...
    forward_base_2_kernel<<<grid_dim, block_dim, sram_size>>>(

...
std::vector<torch::Tensor> forward_base_7(torch::Tensor Q, torch::Tensor K, torch::Tensor V,
    ...
    forward_base_7_kernel<<<grid_dim, block_dim, sram_size>>>(
